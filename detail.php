...
if ( isset($_GET["pro_id"]) ) {
  ...
  $pro = $products->query("SELECT * FROM products ORDER BY RAND() LIMIT 1")[0];
}
...
?>
                    ...
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/img/<?= $imgs[$i]?>" alt="..."></div>
...
?>
                  ...
                  <a class="d-block" href="admin/img/<?= $imgs[$i]?>" data-lightbox="product" title="Product item <?= $i+1 ?>"><img class="img-fluid" src="admin/img/<?= $imgs[$i]?>" alt="..."></a>
...
?>             
            ...
            <div class="col-lg-6">
              ...
              <h1><?= $pro['name'] ?></h1>
              <p class="text-muted lead">$<?= $pro['price'] ?></p>
              ...
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-3 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="fun/do_add_to_cart.php?pro_id=<?= $pro['id'] ?>">Add to cart</a></div>
          ...
          <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              <div class="p-4 p-lg-5 bg-white">
                ...
                <p class="text-muted text-small mb-0"><?= $pro['description'] ?></p>
              </div>
            </div>
...
$prods = $products->query("SELECT * FROM products WHERE cat = :cat_id && id != :pro_id", ["cat_id"=>$cat_id, "pro_id"=>$pro_id]);
...
?>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="product text-center skel-loader">
                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.php?pro_id=<?= $pro['id'] ?>"><img class="img-fluid w-100" src="admin/img/<?= $imgs[0]?>" alt="..."></a>
